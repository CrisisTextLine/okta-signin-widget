        ...
        copy: {
            'app-to-target': {
                files: [
                    ...
                    {
                        expand: true,
                        cwd: 'packages/@okta/courage/src/',
                        src: ['**'],
                        dest: JS + '/shared/'
                    },
                    {
                        expand: true,
                        cwd: 'packages/@okta/courage/src/vendor',
                        src: ['**'],
                        dest: JS + '/vendor/'
                    },
            ...
            'e2e-pages': {
                options: {
                    process: function(content) {
                        var cdnLayout = grunt.file.read('./test/e2e/layouts/cdn.tpl', {
                                encoding: 'utf8'
                            }),
                            npmLayout = grunt.file.read('./test/e2e/layouts/npm.tpl', {
                                encoding: 'utf8'
                            }),
